...
const webdevProjects = [
  ...
  { name: 'Livixa AI', url: 'https://livixa.ai/', desc: 'AI-powered product website.', tag: 'Website', img: 'assets/livixa-ai.jpg' },
  { name: 'Umrah Rafeeqi', url: 'https://umrah.rafeeqi.com/', desc: 'Umrah services booking website.', tag: 'Website', img: 'assets/umrah-rafeeqi.jpg' },
  { name: 'Facility Apps', url: 'https://www.facilityapps.com/', desc: 'Facility management software website.', tag: 'Website', img: 'assets/Facility-Apps.jpg' },
  { name: 'Genx Aminos', url: 'https://genxaminos.com/', desc: 'Supplement brand website.', tag: 'Website', img: 'assets/genx-aminos.jpg' },
  { name: 'Pure Medical Spa', url: 'https://puremedicalspaidaho.com/', desc: 'Med spa & aesthetics clinic website.', tag: 'Website', img: 'assets/pure-medical-spa.jpg' },
  { name: 'Newage Cables', url: 'https://newagecables.com/', desc: 'Cable manufacturing company website.', tag: 'Website', img: 'assets/newage-cables.jpg' },
  { name: 'Haven Compliance', url: 'https://havencompliance.com.au/', desc: 'Window safety compliance company website.', tag: 'Website', img: 'assets/haven-compliance.jpg' },
  { name: 'Murcot Auto', url: 'https://blanchedalmond-chamois-946816.hostingersite.com/', desc: 'Vehicle purchase & trade-in website.', tag: 'Website', pending: true, img: 'assets/murcot-auto.jpg' },
  { name: 'Qareeb', url: 'https://qareeb.com/', desc: 'Shopify store.', tag: 'Shopify', img: 'assets/qareeb.jpg' },
  { name: 'Surmer', url: 'https://surmer.com/', desc: 'Shopify store.', tag: 'Shopify', img: 'assets/surmer.jpg' },
  { name: 'Soap Sage', url: 'https://soapsage.pk/', desc: 'Shopify store.', tag: 'Shopify', img: 'assets/soap-sage.jpg' },
  { name: 'Luxe Auto Spa', url: 'https://luxeautospa.pk/', desc: 'Shopify store.', tag: 'Shopify', img: 'assets/luxe-auto-spa.jpg' },
  { name: 'CNC Electric', url: 'https://www.cncelectric.pk/', desc: 'Shopify store.', tag: 'Shopify', img: 'assets/cnc-electric.jpg' },
];
